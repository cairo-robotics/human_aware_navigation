...
function get_best_shielded_action(veh, nearby_humans, Dt_obs_to_k1, Dt_plan, get_actions::Function, veh_body, human_goal_positions, pomdp, despot, user_defined_rng)
    ...
    v_human_max = 1.25
    safe_HJB_value_lim = 800.0
    shield_actions, shield_action_indices = shield_action_set(x_k1, nbh_pos, Dt_obs_to_k1, Dt_plan, get_actions, veh_body, human_goal_positions, v_human_max, pomdp)
