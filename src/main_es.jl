...
function hg(input_config)
    ...
    return initial_sim_obj, pomdp_planner, pomdp_details, exp_details, output
end

#=
Run the experiment
i,pp,pd,ed,o = hg(input_config);
c= run_experiment!(i,pp,pd,ed,o)
=#
