aspen =  InputParameters(
    ...
    ObstacleLocation[ObstacleLocation(3.2,4.1,0.75),ObstacleLocation(2.2,7.5,0.75)], #=obstacles::Array{obstacle_location,1}=#
    4, #=num_humans::Int64=#
    1.0, #=human_start_v::Float64=#
    2.75, #=veh_start_x::Float64=#
    1.0, #=veh_start_y::Float64=#
    pi, #=veh_start_theta::Float64=#
    0.0, #=veh_start_v::Float64=#
    2.75, #=veh_goal_x::Float64=#
