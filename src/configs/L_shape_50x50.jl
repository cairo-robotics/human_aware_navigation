L_shape_50x50 =  InputParameters(
    MersenneTwister(0x641e5058), #=rng::AbstractRNG=#
    50.0, #=env_length::Float64=#
    50.0, #=env_breadth::Float64=#
    # ObstacleLocation[],
    ObstacleLocation[ObstacleLocation(35,15,15) ], #=obstacles::Array{obstacle_location,1}=#
